 ...
 */
public class PdfviewForIcs extends AbstractIText5PdfView {
...
//                    URL path=new URL("http://storage.googleapis.com/icsmaster/"+model.get(key));
                    String path=getImagePath(model.get(key).toString(),"icsmaster");
