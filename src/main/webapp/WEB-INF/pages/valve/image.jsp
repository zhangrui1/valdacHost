...
<div class="container">
    ...
    <section class="content">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="btn-group" role="group">
                    ...
                    <a href="/valdacHost/list/valve/" class="btn btn-default">戻る</a>
                </div>
            </div>
        </div></br></br>
        <%--図面種類はタブで表示・非表示にする--%>
        <%--<div class="row">--%>
            <%--<div class="col-md-4">--%>
                <%--<div class="btn-group" role="group">--%>
                    <%--<button type="button" class="btn btn-default" onclick="setTagFlg(3)"/>弁関連図面</button>--%>
                    <%--<button type="button" class="btn btn-default" onclick="setTagFlg(1)"/>GP図面</button>--%>
                    <%--<button type="button" class="btn btn-default" onclick="setTagFlg(2)"/>ICS図面</button>--%>
                    <%--<button type="button" class="btn btn-default" onclick="setTagFlg(4)"/>工事関連図面</button>--%>
                <%--</div>--%>
            <%--</div>--%>
        <%--</div></br></br>--%>
        <%--ICS画像を表示する--%>
        ...
        if(type=="1"){
            ...
            if(numallKikisysImageList06>0){
                ...
                $.post("/valdacHost/image/setImagesyuSession", {"type": type}, function (data) {
                    ...
                    setImage(items,true)
                    document.getElementById("valueCurrent").innerHTML ="1";
                    document.getElementById("valueTotal").innerHTML=numallKikisysImageList06+"";
                });
            }else{
                setImage(null,false);
            }
