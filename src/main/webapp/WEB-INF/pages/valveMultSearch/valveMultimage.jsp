...
<div class="row">
    ...
    <div class="col-md-6">
        <div class="btn-group" role="group">
            ...
            <a href="/valdacHost/list/valveMult/" class="btn btn-default">戻る</a>
        </div>
    </div>
</div>
<%--ICS画像を表示する--%>
...
//                document.getElementById('previewImageIcs').src="http://storage.googleapis.com/valdac/"+items.imagename;
                //先頭、最終へボタン設定
                firstAndLastButton(1,1,"firstButtonICS","previousButtonICS","NextButtonICS","lastButtonICS");
                //図面描画
...
//                document.getElementById('previewImageGP').src="http://storage.googleapis.com/valdac/"+items.imagename;
                //先頭、最終へボタン設定
                firstAndLastButton(1,1,"firstButtonGP","previousButtonGP","NextButtonGP","lastButtonGP");
                //図面描画
...
//                document.getElementById('previewImage').src="http://storage.googleapis.com/valdac/"+items.imagename;
                //先頭、最終へボタン設定
                firstAndLastButton(1,1,"firstButtonValve","previousButtonValve","NextButtonValve","lastButtonValve");
                //図面描画
...
//                document.getElementById('previewImageKouji').src="http://storage.googleapis.com/valdacHost/"+items.imagename;
                //先頭、最終へボタン設定
                firstAndLastButton(1,1,"firstButtonKouji","previousButtonKouji","NextButtonKouji","lastButtonKouji");
                //図面描画
...
function loadImg(imgUrl,ImageId) {
    document.getElementById(ImageId).src="/valdacHost/img/blackLoading.gif";
