...
<div class="container">
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="btn-group" role="group">
                        <a href="/valdacHost/list/valveMult" class="btn btn-default" onclick="return saveSelectedForBuhin()">複合検索</a>
                        <a href="/valdacHost/list/valve" class="btn btn-default" onclick="return saveSelectedForBuhin()">弁検索</a>
                        <a href="/valdacHost/list/kikiSearch" class="btn btn-default" onclick="return saveSelectedForBuhin()">機器検索</a>
                        <a href="/valdacHost/list/buhinSearch" class="btn btn-default bg-yellow active" onclick="return saveSelectedForBuhin()" >部品検索</a>
                    </div>
                </div>
            </div></br></br>
            <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="input-group">
                                    <input type="text" name="table_search" id="table_search" class="form-control input-sm pull-right" style="width: 150px;" placeholder="Filter" value="${filterValveKikiBuhin}">
            ...
            <div class="row">
                <div class="panel panel-success">
                    <div class="panel-heading" id="searchForBuhinHeader">
                        <div class="row">
                            <div class="col-md-10">
                                <h4><i class="glyphicon glyphicon-chevron-up" id="iClass"></i> 部品複数条件検索 </h4>
                            </div>
                        </div>
                    </div>
                    <div class="panel-body" id="searchForBuhin" >
                        <div class="row">
                            <div class="col-md-14">
                                <form action="/valdacHost/item/buhinSearchForSeikak" method="post" class="sidebar-form"  name="buhinsearchFormForSeikak" onsubmit="return checkValveSearchForSeikak();">
                                    <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-5">
                                                <%--<input type="text" id="bikou" name="bikou" class="form-control" value="${buhinSearchForSeikak.bikou}" />--%>
                                                <div class="input-group">
                                                    <select id="bikou" name="bikou" class="form-control" value="">
                                                        <option>全部会社名</option>
                                            ...
                                            <div class="col-md-2">
                                                <%--<input type="text" id="buhinKbn" name="buhinKbn" class="form-control" value="${buhinSearchForSeikak.buhinKbn}" />--%>
                                                <select id="buhinKbn" name="buhinKbn" class="form-control" value="">
                                                    <option  <c:if test="${(buhinSearchForSeikak.buhinKbn eq '')}">selected</c:if>></option>
                                                    <option  <c:if test="${(buhinSearchForSeikak.buhinKbn eq '消耗資材')}">selected</c:if>>消耗資材</option>
                                                    <option  <c:if test="${(buhinSearchForSeikak.buhinKbn eq '経年部品')}">selected</c:if>>経年部品</option>
                                                    <option  <c:if test="${(buhinSearchForSeikak.buhinKbn eq '接管資材')}">selected</c:if>>接管資材</option>
                                                </select>
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            ...
                                            <div class="col-md-2">
                                                <%--<input type="text" id="asbKbn" name="asbKbn" class="form-control" value="${buhinSearchForSeikak.asbKbn}" />--%>
                                                <select id="asbKbn" name="asbKbn" class="form-control" value="">
                                                    <option  <c:if test="${(buhinSearchForSeikak.asbKbn eq '')}">selected</c:if>></option>
                                                    <option  <c:if test="${(buhinSearchForSeikak.asbKbn eq 'アスベスト品')}">selected</c:if>>アスベスト品</option>
                                                    <option  <c:if test="${(buhinSearchForSeikak.asbKbn eq 'ノンアスベスト品')}">selected</c:if>>ノンアスベスト品</option>
                                                    <option  <c:if test="${(buhinSearchForSeikak.asbKbn eq '混在品')}">selected</c:if>>混在品</option>
                                                    <option  <c:if test="${(buhinSearchForSeikak.asbKbn eq '対象外')}">selected</c:if>>対象外</option>
                                                </select>
                                            </div>
                                            <div class="col-md-1">
                                                使用箇所
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" id="siyouKasyo" name="siyouKasyo" class="form-control" value="${buhinSearchForSeikak.siyouKasyo}" />
                                            </div>
                                            <div class="col-md-1">
                                                部品名
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" id="buhinMei" name="buhinMei" class="form-control" value="${buhinSearchForSeikak.buhinMei}" />
                                            </div>
                                            <div class="col-md-1">
                                                標準仕様
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" id="hyojunSiyou" name="hyojunSiyou" class="form-control" value="${buhinSearchForSeikak.hyojunSiyou}" />
                                            </div>
                                        </div><br>
                                        <div class="row">
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" id="sunpou" name="sunpou" class="form-control" value="${buhinSearchForSeikak.sunpou}" />
                                            </div>
                                            <div class="col-md-1">
                                                数量
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" id="suryo"  name="suryo" class="form-control" value="${buhinSearchForSeikak.suryo}" />
                                            </div>
                                            <div class="col-md-1">
                                                資材名
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" id="sizaiName" name="sizaiName" class="form-control" value="${buhinSearchForSeikak.sizaiName}" />
                                            </div>
                                            <div class="col-md-1">
                                                品番
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" id="hinban" name="hinban" class="form-control" value="${buhinSearchForSeikak.hinban}" />
                                            </div>
                                        </div></br>
                                        <div class="row">
                                            <div class="col-md-1">
                                            ...
                                            <div class="col-md-2">
                                                <input type="text" id="makerRyaku" name="makerRyaku" class="form-control maker" placeholder="略称" value="${buhinSearchForSeikak.makerRyaku}" />
                                            </div>
                                            <div class="col-md-2">
                                                <input type="text" id="maker" name="maker" class="form-control maker" placeholder="メーカー" value="${buhinSearchForSeikak.maker}" />
                                            </div>
                                        </div></br>
                                        <div class="box-body clearfix">
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    <span id="valve_num" class="valve_num pull-right" STYLE="font-size: 16px;">ヒット弁 ${buhinSearchitemNum} 台</span>
                                                </div>
                                                <div class="col-md-2">
                        ...
                        <div class="box-body no-padding">
                            <div class="list-group kiki-list result-list">
                                <table class="table table-hover select-table result-table table-bordered">
                                    ...
                                    <tbody>
                                    <c:forEach items="${buhinSearchitemResults}" var="item">
                                        <tr class="valve-item" id="${item.valve.kikiSysId}">
                                            ...
                                            <td nowrap>
                                                <a class="btn btn-primary btn-sm operation-button-btn" href="/valdacHost/item/${item.valve.kikiSysId}/${kikiOrBenFlg}/valve" onclick="return saveSelectedForBuhin()">詳細</a>
                                            </td>
                                            ...
                                            <td nowrap class="data-td">${item.buhins.get(0).buhinKbn}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).asbKbn}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).siyouKasyo}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).buhinMei}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).hyojunSiyou}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).sunpou}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).sizaiName}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).makerRyaku}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).maker}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).hinban}</td>
                                            <td nowrap class="data-td">${item.buhins.get(0).updDate}</td>
                                            <td nowrap>
                                                <a class="btn btn-primary btn-sm operation-button-btn" href="/valdacHost/item/${item.valve.kikiSysId}/${kikiOrBenFlg}/valve" onclick="return saveSelectedForBuhin()">詳細</a>
                                            </td>
                                        </tr>
...
//        });
        ...
        var locationFirst="${buhinSearchForSeikak.bikou}";
    ...
    function filterPage(){
        ...
        //sessionに保存
        $.get("/valdacHost/item/valveKikiBuhinFilter",{"filterKeyword":keyword},function(data){
            return true;
        });
    };
    //画面描画時　Filter
...
//        var isKenan=false;
    ...
    function check(code){
        if(code==13) {
            ...
            //buhin検索条件取得
            $('.buhin-radio:checked').each(function () {
                $('#buhinRadioSelect').val($(this)[0].value);
            });
            //処理待ち中にアニメーション表示する
            $("#loading").fadeIn();
            //sessionに保存
            $.get("/valdacHost/item/valveKikiBuhinFilter", {"filterKeyword": ""}, function (data) {
                return true;
            });
    ...
    function checkValveSearchForSeikak(){
        var tmp="";
//        tmp=tmp+$("#bikou").val();
        tmp=tmp+$("#buhinKbn").val();
        tmp=tmp+$("#asbKbn").val();
        tmp=tmp+$("#siyouKasyo").val();
        tmp=tmp+$("#buhinMei").val();
        tmp=tmp+$("#hyojunSiyou").val();
        tmp=tmp+$("#sunpou").val();
        tmp=tmp+$("#suryo").val();
        tmp=tmp+$("#sizaiName").val();
        tmp=tmp+$("#hinban").val();
...
//        }
    ...
    function saveSelectedForBuhin(){
        ...
        //Filter sessionに保存
        $.get("/valdacHost/item/saveSelectedForValve",{"idList":idList,"type":"3"},function(data){
            return true;
        });
    }
    //選択された部品を再秒化する
    function setSelectedForBuhin(){
        var tmp = "${saveSelectedForBuhin}";
        if(tmp.length>0){
            var tmp2=tmp.split(",");
