        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="btn-group" role="group">
                    <a href="/valdacHost/list/valveMult" class="btn btn-default" onclick="return saveSelectedForValve()">複合検索</a>
                    <a href="/valdacHost/list/valve" class="btn btn-default bg-yellow active" onclick="return saveSelectedForValve()">弁検索</a>
            ...
            <div class="panel panel-success">
                ...
                <div class="panel-body" id="lunceSearchForValve" style="display:none;">
                    ...
                    <%--<div class="row">--%>
                        ...
                        <div class="col-md-4">
                            <form action="/valdacHost/item/valveSearch" method="post" class="sidebar-form"  name="valveSearchForm">
                                <div class="input-group">
        ...
        <div class="row">
            <div class="panel panel-success">
                ...
                <div class="panel-body" id="searchForValve" style="display:block;">
                    <div class="row">
                        <div class="col-md-14">
                            <form action="/valdacHost/item/valveSearchForSeikak" method="post" class="sidebar-form"  name="searchForValve" onsubmit="return checkValveSearchForSeikak();">
                                <div class="box-body">
                                        <div class="row">
                                            <div class="col-md-1">
                                    ...
                                    <div class="box-body clearfix">
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <span id="valve_num" class="valve_num pull-right" STYLE="font-size: 16px;">ヒット弁 ${valveSearchitemNum} 台</span>
                                            </div>
                                            <div class="col-md-2">
...
//         var tr = document.getElementById("select-"+obj.value);
    ...
    function check(code){
        if(code==13){
            ...
            //Filter sessionに保存
            $.get("/valdacHost/item/valveFilter",{"filterKeyword":""},function(data){
                return true;
            });
     ...
     //選択された弁を記録する
        function saveSelectedForValve(){
            ...
            //Filter sessionに保存
            $.get("/valdacHost/item/saveSelectedForValve",{"idList":idList,"type":"1"},function(data){
                return true;
        });
}
     //選択された弁を再秒化する
