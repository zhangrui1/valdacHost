                    ...
                    <div class="col-md-8">
                        <div class="btn-group">
                            <a class="btn btn-default dropdown-toggle" type="button" data-toggle="dropdown" aria-expanded="false">
                                今回懸案リスト <i class="fa fa-angle-down"></i>
                            </a>
                    ...
                    <div class="panel-body">
                        <div class="col-md-3" style="padding-right: 0px">
                            <ul class="list-group tab-list">
                                <c:forEach items="${valvesThisYear}" var="valve">
                                    <li onclick="chooseThisValveNowKenan(this)" class="list-group-item tab-item">
                                        <div class="row">
                        ...
                        <div class="col-md-9" style="padding-left: 0px;box-shadow: 0px 2px 5px 2px #ccc;">
                            <div class="kenanList-div">
                                <table class="table table-hover" id="kenan-table">
                                    ...
                                    <tbody class="list-group item-list" id="kenanList-now">
...
//                            '<td class="data-td">'+kikiDatas[i].syotiNaiyou+'</td>'+
    ...
    function chooseThisValveNowKenan(obj){
        ...
        $.post("/valdacHost/kouji/kenanNowYear",{"koujiId":koujiId,"kikiSysId":kikiSysId},function(data){
                var kikiDatas = JSON.parse(data);
                $("#kenanList-now").html("");
                var tmpHTML = "";
                for(var i = 0; i < kikiDatas.length;i++){
